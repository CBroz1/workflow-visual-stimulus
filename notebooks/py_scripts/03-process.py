...
# This notebook gives instructions for running the stimulus generation feature of `element-visual-stimulus`. DataJoint needs to be configured before running this notebook. If you haven't set up the configuration, refer to notebook [01-configure](01-configure.ipynb). For more information on exploring tables within DataJoint, see notebook [02-workflow-structure](02-workflow-structure-optional.ipynb).
#
# ## Setup
#
# First, change to the parent directory for `dj_local_config.json`
...
element_path = dj.config['custom']['vis_stim_dir'] # Change with your path to the element
